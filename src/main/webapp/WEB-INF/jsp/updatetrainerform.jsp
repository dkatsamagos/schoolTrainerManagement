<%-- 
    ...
    Created on : Jun 29, 2020, 11:39:01 AM
    Author     : dkats
--%>
            ...
            <div class="col-sm-6 mb-3 mb-md-0 m-5">
                <div class="card border-primary">
                    <div class="card-header bg-primary mb-3">
                        <div class="card-title text-white text-center h5">Update Trainer</div>
                    </div>
                    <div class="card-body">
                        <springform:form action="addTrainer" method="post" modelAttribute="trainer">


                            <div class="form-group">
                                <label for="id" class="col-md-3 control-label">ID : ${trainer.id}</label>
                                <div class="col-md-9">
                                    <springform:hidden path="id" cssClass="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-offset-3 col-md-9">
                                <springform:button class="btn btn-primary">Update</springform:button>
                                </div>   
